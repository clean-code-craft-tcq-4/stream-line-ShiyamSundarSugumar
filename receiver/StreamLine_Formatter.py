...
class dataFormatter
    def dataReadFromconsole(self, data):
        data = sys.stdin.readlines()
        input_data = ''
        print(data)
        return data
    consoledata = dataReadFromconsole(data)
    
    def dataformatter(self, formattedData):
        formattedData = [re.sub('[^a-zA-Z0-9]', "", _) for _ in formattedData]
        print(formattedData)   
